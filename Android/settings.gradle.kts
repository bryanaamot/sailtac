...
pluginManagement {
    ...
    if (System.getenv("BUILT_PRODUCTS_DIR") == null) {
        System.setProperty("BUILT_PRODUCTS_DIR", "${System.getProperty("user.home")}/Library/Developer/Xcode/DerivedData/SailTac-czxzhamvdgrqafeaosetdkymnuox/Build/Products/Debug-iphonesimulator")
    }
